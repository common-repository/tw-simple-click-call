...
class Base
{
	public function twscc_save_twilio_details(){		
		global $wpdb;
	...
	public function twscc_get_warning_logs($sid,$auth_token)
	{
		include( TWSCC_PLUGIN_PATH. 'twilio-php/Services/Twilio.php');
	...
	public function twscc_get_call_logs($sid,$auth_token)
	{
		//include( TWSCC_PLUGIN_PATH. 'twilio-php/Services/Twilio.php');
	...
	public function api_request($data)
	{
		if(isset($data['action']) && $data['action']=="create_twilio_api")
		{
			if($data['account_sid']!="" && $data['auth_token']!="")
			{
					    ...
					    try 
					    {
							$directory = TWSCC_PLUGIN_PATH."twimil_xml";
							...
							$voiceURL = TWSCC_PLUGIN_URL."twimil_xml/".$newfile;
							include( TWSCC_PLUGIN_PATH. 'twilio-php/Services/Twilio.php');
							$sid = $data['account_sid'];
					//echo "   ";
							$token = $data['auth_token'];
	...
	public function twscc_get_twilio_details(){
